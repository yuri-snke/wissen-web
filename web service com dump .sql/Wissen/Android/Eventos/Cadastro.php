...
$statement = mysqli_prepare($con, "INSERT INTO `tbl_eventos` (`Nome`, `DataInicio`, `DataTermino`, `HoraInicio`, `HoraTermino`, `Responsavel`, `Preco`, `Descricao`, `Imagens`,`Lat`,`Longi`, `ImagemCapa`, `CEP`,`Estado`,`Cidade`,`Bairro`, `Local`, `Endereco`, `TelFixo`, `TelMovel`, `EmailCriador`, `Tipo`, `Privado`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)") or die("Erro no statement");

mysqli_stmt_bind_param($statement, "sssssssssssssssssssssss", $Nome, $DataInicio, $DataTermino, $HoraInicio, $HoraTermino, $Responsavel, $Preco, $Descricao, $Imagens,$Lat,$Long, $ImagemCapa, $CEP,$Estado,$Cidade,$Bairro, $Local, $Endereco, $TelFixo, $TelMovel, $EmailCriador, $Tipo, $Privado) or die("Erro no param");
