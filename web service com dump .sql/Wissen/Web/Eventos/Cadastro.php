...
$statement = mysqli_prepare($con, "INSERT INTO `tbl_eventos` (`Nome`, `DataInicio`, `DataTermino`, `HoraInicio`, `HoraTermino`, `Responsavel`, `Preco`, `Descricao`, `Imagens`, `ImagemCapa`, `CEP`,`Estado`,`Cidade`,`Bairro`, `Local`, `Endereco`, `TelFixo`, `TelMovel`, `EmailCriador`, `Tipo`, `CpfCnpj`, `Privado`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)") or die("Erro no statement");

mysqli_stmt_bind_param($statement, "ssssssssssssssssssssss", $Nome, $DataInicio, $DataTermino, $HoraInicio, $HoraTermino, $Responsavel, $Preco, $Descricao, $Imagens, $ImagemCapa, $CEP,$Estado,$Cidade,$Bairro, $Local, $Endereco, $TelFixo, $TelMovel, $EmailCriador, $Tipo, $CpfCnpj ,$Privado) or die("Erro no param");
