...
public class FollowersEvent {
    ...
    private String imagemPerfil_User;
    private String StatusFollow;

    public String getStatusFollow() {
        return StatusFollow;
    }

    public void setStatusFollow(String StatusFollow) {
    ...
    public String getImagemPerfil_User() {
        return imagemPerfil_User;
    }

    public void setImagemPerfil_User(String imagemPerfil_User) {
        this.imagemPerfil_User = imagemPerfil_User;
    }
