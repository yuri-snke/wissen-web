                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <fieldset>
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input id="icon_cpf" type="text" name="cpf" data-minlength="11" data-error="Obrigatório 4 dígitos" required>
                            <div class="help-block with-errors text-center"></div>
                        </div>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="input-file-container">  
                                <input class="input-file" id="my-file" type="file" name="fotoCapa" accept="image/*" required>
                        ...
                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="input-file-container-2">  
                                <input class="input-file-2" id="my-file-2" type="file" name="foto2" accept="image/*" required>
                        ...
                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="input-file-container-3">  
                                <input class="input-file-3" id="my-file-3" type="file" name="foto3" accept="image/*" required>
